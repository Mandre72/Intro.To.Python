...
def longer_words_list(array_6, number1):
    return [word for word in array_6 if len(word) > number1]
print(longer_words_list(list_6, 4))
...
def find_item_lists(array_7, array_8):
    return any(item in array_8 for item in array_7)
...
def even_items_list(array_11):
    return [num for num in array_11 if num % 2 == 0]
