...
# Enter two numbers between 1 and 10, save these values to number_1 variable and number_2 variables.
...
elif (5 < number_1 <= 10 and not (0 < number_2 <= 5)) or (5 < number_2 <= 10 and not (0 < number_1 <= 5)):
    result_2 = number_1 + number_2
